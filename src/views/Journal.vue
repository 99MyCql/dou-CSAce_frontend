<template>
  <div class="main-content">
    ...
    <div class="container-fluid">
      ...
      <div class="mt-6" v-loading="paperTable.loading">
        <div class="row align-items-center mt-5 px-3">
          <div class="col-md-4">
            <div class="h3 mb-0">论文列表</div>
          </div>
        ...
        <div v-for="paper in paperTable.papers" :key="paper._key">
            ...
            <div class="card-body pb-3">
              ...
              <div class="px-4" style="font-family: tahoma">
                <p class="card-text mb-0 text-muted font-italic">
                  {{ paper.year }}
                  <router-link v-if="paper.venue" class="mr-1" :to="{ path: '#' }">
                    {{ paper.venue._key }}
                  </router-link>
                </p>
        ...
        <div class="text-center mt-3">
          <el-pagination
            ...
            :total="journal.paperCount"
            @current-change="paperTableChang">
          </el-pagination>
        </div>
      </div>
    </div>
